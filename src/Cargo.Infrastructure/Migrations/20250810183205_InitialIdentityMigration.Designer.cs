...
namespace Cargo.Infrastructure.Migrations
{
    ...
    [Migration("20250810183205_InitialIdentityMigration")]
                    ...
                    b.OwnsOne("Cargo.Domain.ValueObjects.DriverSettings", "Settings", b1 =>
                        {
                            ...
                            b1.Property<decimal>("AdminFee")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("Settings_AdminFee");

                            b1.Property<int>("FscMode")
                                .HasColumnType("int")
                                .HasColumnName("Settings_FscMode");

                            b1.Property<decimal>("FscRate")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("Settings_FscRate");

                            b1.Property<decimal>("HourlyRate")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("Settings_HourlyRate");

                            b1.Property<int>("NumPayBands")
                                .HasColumnType("int")
                                .HasColumnName("Settings_NumPayBands");

                            b1.Property<string>("Province")
                                .IsRequired()
                                .HasMaxLength(50)
                                .HasColumnType("nvarchar(50)")
                                .HasColumnName("Settings_Province");

                            b1.Property<decimal>("WaitingPerMinute")
                                .HasPrecision(18, 2)
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("Settings_WaitingPerMinute");
                            ...
                            b1.OwnsOne("Cargo.Domain.ValueObjects.TaxProfile", "TaxProfile", b2 =>
                                {
                                    b2.Property<Guid>("DriverSettingsDriverId")
                                        .HasColumnType("uniqueidentifier");

                                    b2.Property<bool>("CompoundQstOverGst")
                                        .HasColumnType("bit")
                                        .HasColumnName("Settings_TaxProfile_CompoundQstOverGst");

                                    b2.Property<decimal>("GstRate")
                                        .HasPrecision(5, 4)
                                        .HasColumnType("decimal(5,4)")
                                        .HasColumnName("Settings_TaxProfile_GstRate");

                                    b2.Property<decimal>("HstRate")
                                        .HasPrecision(5, 4)
                                        .HasColumnType("decimal(5,4)")
                                        .HasColumnName("Settings_TaxProfile_HstRate");

                                    b2.Property<decimal>("PstRate")
                                        .HasPrecision(5, 4)
                                        .HasColumnType("decimal(5,4)")
                                        .HasColumnName("Settings_TaxProfile_PstRate");

                                    b2.Property<decimal>("QstRate")
                                        .HasPrecision(5, 4)
                                        .HasColumnType("decimal(5,4)")
                                        .HasColumnName("Settings_TaxProfile_QstRate");

                                    b2.HasKey("DriverSettingsDriverId");

                                    b2.ToTable("Drivers");

                                    b2.WithOwner()
                                        .HasForeignKey("DriverSettingsDriverId");
                                });
